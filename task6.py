...
st.markdown("This app researches smartwatch competitors using Tavily API and generates a structured market analysis report with charts and graphs.")
...
if st.button("Run Research"):
    with st.spinner("Researching live market data..."):
        ...
        ax2.pie(sentiment_values, labels=sentiment_labels, autopct='%1.1f%%', colors=['#2ecc71','#f1c40f','#e74c3c'])
